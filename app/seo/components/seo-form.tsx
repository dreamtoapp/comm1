      ...
      <Tabs defaultValue="basic" className="w-full">
        ...
        <TabsContent value="basic" className="space-y-6 pt-6">
          <div className='grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-2'>
            <div className="space-y-2">
              ...
              />
              {errors.entityId && <p id="entityId-error" className='text-sm text-destructive'>{errors.entityId[0]}</p>}
        ...
        <TabsContent value="advanced" className="space-y-6 pt-6">
          <div className="space-y-2">
            ...
            />
            {errors.schemaOrg && <p id="schemaOrg-error" className='text-sm text-destructive'>{errors.schemaOrg[0]}</p>}
          ...
          <div className="space-y-2">
            ...
            />
            {errors.industryData && <p id="industryData-error" className='text-sm text-destructive'>{errors.industryData[0]}</p>}
