...
import PromotionsTableClientActions from './PromotionsTableClientActions'; // Import the actions component
      ...
      <table className="rtl w-full text-right text-sm table-auto">
        <thead className="bg-accent text-accent-foreground">
          <tr>
            ...
            <th className="px-4 py-3">الخصم</th>{/* <th className="px-4 py-3">كود الخصم</th> */} {/* Commented out */}
            <th className="px-4 py-3">المنتجات (عدد)</th>
