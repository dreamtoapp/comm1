...
import { Check, DollarSign, UserIcon } from 'lucide-react';
        ...
        <CardFooter className='flex h-[80px] flex-col items-center justify-center gap-2'>
          {!product.outOfStock ? (
            ...
            <div className='flex w-full flex-col gap-2'>
              <div className='flex w-full items-center justify-center rounded-2xl bg-red-500 px-3 py-1 text-white shadow-lg'>
                غير متوفر
              </div>
